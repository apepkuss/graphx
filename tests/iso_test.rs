...
use graphx::{graph::{DiGraph, Node}, algorithm::isomorphism as iso};
...
fn iso_digraph_weight_test() {
    ...
    assert!(mapping[0].iter().any(|(g1_name, g2_name)| g1_name.as_str() == "B" && g2_name.as_str() == "1"));
    assert!(mapping[0].iter().any(|(g1_name, g2_name)| g1_name.as_str() == "C" && g2_name.as_str() == "2"));
    assert!(mapping[0].iter().any(|(g1_name, g2_name)| g1_name.as_str() == "D" && g2_name.as_str() == "3"));
    assert!(mapping[0].iter().any(|(g1_name, g2_name)| g1_name.as_str() == "E" && g2_name.as_str() == "4")); 
}
